...
class ModMulInput(mult_width: Int, multcand_width: Int, mod_width: Int)
    extends Bundle {
...
class ModMul(val mult_width: Int, val multcand_width: Int, val mod_width: Int)
    extends Module {
  val din = IO(
    Flipped(Decoupled(new ModMulInput(mult_width, multcand_width, mod_width)))
  )
